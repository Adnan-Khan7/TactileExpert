...
#SBATCH --job-name=eval_new_splits
#SBATCH --time=00:30:00
#SBATCH --nodes=1
#SBATCH --gpus-per-node=h100:1
#SBATCH --cpus-per-task=4
#SBATCH --mem=32G
#SBATCH --output=logs/eval_new_splits_%j.out
#SBATCH --error=logs/eval_new_splits_%j.err
...
python "$REPO/research/baselines/eval_on_new_splits.py"
